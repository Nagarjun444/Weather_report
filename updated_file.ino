...
client.println("<button class=\"emoji\"> &#128542;</button>");
  ...
  client.println("let userInput = document.querySelector('#userInput');");
  client.println("let message = document.querySelector('#message');");
  client.println("message.innerHTML = 'Your Quote is Displayed as like this, ' + userInput.value;");
  client.println("}");
  client.println("</script>");
client.println("</body>");
