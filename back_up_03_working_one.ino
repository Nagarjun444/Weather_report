...
int weather_on_off,time_on_off,quote_on_off;
...
<!DOCTYPE HTML>
      ...
      <body>
        ...
        <button class="button on-button" onclick="location.href='/Weather_ON'">Weather_ON</button>
        <button class="button off-button" onclick="location.href='/Weather_OFF'">Weather_OFF</button><br>
        
        <button class="button on-button" onclick="location.href='/TIME_ON'">TIME_ON</button>
        <button class="button off-button" onclick="location.href='/TIME_OFF'">TIME_OFF</button><br>

        <button class="button on-button" onclick="location.href='/u_r_quote_on'">u_r_quote_ON</button>
        <button class="button off-button" onclick="location.href='/u_r_quote_off'">u_r_quote_OFF</button><br>
        
        <button class="emoji">&#128512;</button><br><br>
        <button class="emoji">&#128517;</button><br><br>
        <button class="emoji">&#128522;</button><br><br>
        <button class="emoji">&#128525;</button><br><br>
...
//------------------------------Quote_print_ON------------------------------------------
 server.on("/u_r_quote_on", HTTP_GET, [](AsyncWebServerRequest *request) 
  {
...
//------------------------------Quote_print_OFF------------------------------------------
   server.on("/u_r_quote_off", HTTP_GET, [](AsyncWebServerRequest *request) 
  {
