...
void loop() 
{
   if(d1 == 1)
   {
    Serial.println(" if part is enterd d1 is printed to the serial moniter");
   // d1=0;
   }
   else if(d1 == 0)
   {
    d1=0;
     Serial.println("else part is enterd d1 is printed to the serial moniter");
   }
